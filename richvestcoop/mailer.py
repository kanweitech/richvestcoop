...
class Mailer(object):
    ...
    def send_messages(self, subject, template, context, to_emails, from_email):
        messages = self.__generate_messages(
            subject, template, context, to_emails, from_email
        )
    ...
    def __generate_messages(self, subject, template, context, to_emails, from_email):
        """
        ...
        for recipient in to_emails:
            ...
            message = EmailMessage(
                subject, message_content, to=[recipient], from_email=from_email
            )
